...
<form action="/recruit/edit/complete" method="post" name="recruitForm" id="recruitForm" enctype="multipart/form-data"> 
       	<div class="row" style="margin-top:5%;">
       	<div class="col-md-6 center" >		
            <div class="form-group row" >
				    <label for="title" class="col-sm-2 col-form-label col-form-label-lg">글 제목</label>
				    <div class="col-sm-10">
				      <input type="text" class="form-control form-control-lg" id="title" name="title" value="${list.title}" placeholder="글 제목을 입력해주세요." maxlength="30">
				   		<input type="hidden" value="${ list.recruit_num}" name="recruit_num" id="recruit_num">
				    </div>
			 </div>
			 </div>
		</div>
                    ...
                    <div class="col-md-6">
                        <div class="profile-head">
							  <div class="form-group row">
							    ...
							    <div class="col-sm-8">
							      <input type="text" class="form-control" id="project_name" name="project_name" value="${list.project_name}" maxlength="20">
							    </div>	 
							  </div>
							   <br>
						  ...
						  <div class="form-group row">
							    ...
							    <div class="col-sm-8">
							      <input type="text" class="form-control" id="simple_info" name="simple_info" value="${list.simple_info}"maxlength="40">
							    </div>
							  </div>
							  <br>
							...
							<div class="form-group row">
							    ...
							    <div class="col-sm-8">
                                        <input type="date" id="start_date" name="start_date" min="2021-08-01" max="2025-12-31" value="${list.start_date} "> ~ 
                                       <input type="date" id="end_date" name="end_date" min="2021-08-01" max="2025-12-31"  value="${list.end_date}">
                                 </div>
                      ...
                      <div class="col-md-8">
                        <div class="tab-content profile-tab" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
					            ...
					            style="width:630px; height:400px;"><c:out value="${list.content}" ></c:out> </textarea>
                            ...
                            <div class="tab-pane fade" id="project_content" role="tabpanel" aria-labelledby="project_content-tab">
                              ...
                              <textarea class="form-control" id="pj_content" name="pj_content" rows="8" maxlength="500"
					            style="width:630px; height:400px;"><c:out value="${list.pj_content}" ></c:out></textarea>
